      ...
      <div className='flex flex-wrap items-center justify-between gap-3 rounded-xl bg-other-tonal-fill5 p-4'>
        <div className='flex flex-col gap-1'>
          <Text detail color='text.secondary'>
            Arriving in {chain.wallet?.prettyName ?? 'your wallet'} on Injective
          </Text>
          <button
            type='button'
    ...
    <div className='flex flex-col gap-4'>
      <div className='flex flex-col gap-1'>
        ...
        <Text small color='text.secondary'>
          Deposits arrive on Injective first, then move into Penumbra in one signature. Pick the
          wallet that holds your Injective address.
        </Text>
      </div>
  ...
  const body = (
    <>
      {logo ? (
        ...
        <div className='h-8 w-8 rounded-md bg-other-tonal-fill10' />
      )}
